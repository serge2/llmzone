...
<script lang="ts">
  ...
  const effectiveSettings = $derived.by(() => {
    ...
    return {
      ...
      topK: currentWorkspace.settings.topK,
      topKEnabled: currentWorkspace.settings.topKEnabled ?? false,
      ...
      maxTokens: currentWorkspace.settings.maxTokens,
      maxTokensEnabled: currentWorkspace.settings.maxTokensEnabled ?? false,
      ...
      frequencyPenalty: currentWorkspace.settings.frequencyPenalty,
      frequencyPenaltyEnabled: currentWorkspace.settings.frequencyPenaltyEnabled ?? false,
      presencePenalty: currentWorkspace.settings.presencePenalty,
      presencePenaltyEnabled: currentWorkspace.settings.presencePenaltyEnabled ?? false,
      ...
      verbosity: currentWorkspace.settings.verbosity,
      verbosityEnabled: currentWorkspace.settings.verbosityEnabled ?? false,
      // MCP и логика
      ...
      const loadedWorkspaces = await Promise.all(config.workspaces.map(async (ws) => {
        ...
        return {
          ...
          settings: {
            ...
            topKEnabled: ws.settings.topKEnabled ?? false,
            maxCompletionTokensEnabled: ws.settings.maxCompletionTokensEnabled ?? false,
            maxTokensEnabled: ws.settings.maxTokensEnabled ?? false,
            ...
            frequencyPenaltyEnabled: ws.settings.frequencyPenaltyEnabled ?? false,
            presencePenaltyEnabled: ws.settings.presencePenaltyEnabled ?? false,
            ...
            verbosityEnabled: ws.settings.verbosityEnabled ?? false,
            ...ws.settings
          },
